...
d3.json("eu.json", function(error, eu) {
  ...
  svg.append("path")
    ...
    document.getElementById("buttonAll").onclick = function(){all = true; older = false; middle = false; youngest = false; filterQuantity(quantityData);};
    
    document.getElementById("buttonOld").onclick = function(){all = false; older = true; middle = false; youngest = false;filterQuantity(quantityData);};
    
    document.getElementById("buttonMiddle").onclick = function(){all = false; older = false; middle = true; youngest = false;filterQuantity(quantityData);};
    
    document.getElementById("buttonYoungest").onclick = function(){all = false; older = false; middle = false; youngest = true;filterQuantity(quantityData);};
});
